            ...
            {printMode === 'POSTER' || printMode === 'PHUNG_VI' ? (() => {
              ...
              return pages.map((pageCols, pageIdx) => (
                <div
                  ...
                  className={`so-page-block bg-white text-black w-full min-h-[50vh] print:h-[98vh] print:w-full print:m-0 print:p-0 relative overflow-hidden print:block ${pageIdx !== pages.length - 1 ? 'break-after-page' : ''}`}
                  style={{ 
                    pageBreakAfter: pageIdx === pages.length - 1 ? 'auto' : 'always', 
                    page: 'so-page' as any,
                    paddingTop: printMode === 'PHUNG_VI' ? '2.5cm' : '1cm'
                  }}
                >
                  <table 
                    className="mx-auto" 
